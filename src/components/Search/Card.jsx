export default function Card({color, value}){
    ...
    const handleClick = () => {
        ...
        alert('Color Code is copied to Clipboard.')
    }

    return (
        <div onClick={handleClick} className="color-card cursor-pointer z-0 h-40 w-72 rounded-md overflow-hidden relative group flex items-center justify-center border-2 border-white hover:border-black" style={{color: `${color}`}}>
