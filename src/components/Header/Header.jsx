...
export default function Header(){
  return (
    <div className="header-bg fixed top-0 left-0 w-full h-24 z-50 flex flex-col md:flex-row items-center justify-between px-5 py-3 md:px-20 md:py-5 shadow-md shadow-black">
      <div>
        <Link to="/" ><img src={Logo} className='h-8 w-25 mb-2 md:mb-0'/></Link>
      </div>
